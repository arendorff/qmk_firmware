...
/* include for german keymap aliases */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
      ...
      //--------------------------------------------------------------------------         ---------------------------------------------------------------------------------
        KC_ESCAPE, DE_A,    DE_S,    DE_D,    DE_F,    DE_G,                                 DE_H,    DE_J,    DE_K,    DE_L,    KC_SCLN, KC_QUOT,
      //--------------------------------------------------------------------------         ---------------------------------------------------------------------------------
        KC_LSFT,   DE_Y,    DE_X,    DE_C,    DE_V,    DE_B,                                 DE_N,    DE_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
      //--------------------------------------------------------------------------         ---------------------------------------------------------------------------------
